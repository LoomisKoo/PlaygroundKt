package com.example.aptlibrary.butterknife;
...
public class BindFieldViewServiceCollection {
    ...
    public void play(ProcessingEnvironment processingEnvironment) {
        ...
        MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder("bind")
                ...
                .returns(ClassName.get("com.example.playgroundkt.myinterface.butterknife", "IBind"))
        ...
        TypeSpec finderClass = TypeSpec.classBuilder("BindFieldViewService")
                .addModifiers(Modifier.PUBLIC)
                .addSuperinterface(ClassName.get("com.example.playgroundkt.myinterface.butterknife", "IBindFieldViewService"))
                .addMethod(methodBuilder.build())
                .build();
        try {
            JavaFile.builder("com.example.playgroundkt.myinterface.butterknife", finderClass).build().writeTo(processingEnvironment.getFiler());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
